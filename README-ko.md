...
| **반복 알림** | 읽지 않은 알림이 남아 있는 동안 5~1440분마다 다시 켜집니다. |
...
> **권한에 대하여.** 알림으로 화면을 켜는 기본 기능은 알림 접근 권한만 필요하며 인터넷 권한을 요청하지 않습니다.
> 선택 기능인 화면 켜짐 시간 설정은 Android 9 이상에서 접근성 권한을, 블루투스 조건은 Android 12 이상에서 근처 기기 권한을 사용합니다.
> 반복 알림 진동에는 일반 진동 권한을 사용합니다. 새 기능은 기본적으로 꺼져 있거나 기존 설정을 따르며 화면 내용을 읽지 않습니다.

## 그 밖의 기능

모두 자유롭게 켜고 끌 수 있습니다.

- **반복 알림 설정** — 대상 앱, 5~1440분 간격, 별도의 화면 켜짐 시간 및 선택적 진동을 설정합니다. 절전 기능으로 알림이 지연될 수 있습니다
- **블루투스 조건** — 선택한 페어링 기기가 연결된 것으로 감지될 때만 화면을 켭니다
