...
|---|---|---|
| :bell: | **ปลุกทันที** | หน้าจอสว่างขึ้นทันทีที่มีการแจ้งเตือน |
| :sun_with_face: | **โหมดในกระเป๋า** | ตรวจจับได้ว่าเครื่องอยู่ในกระเป๋าเสื้อหรือกระเป๋าถือ แล้วปล่อยให้หน้าจอดับไว้ |
| :repeat: | **เตือนซ้ำ** | สว่างซ้ำทุก 5–60 นาที ตราบใดที่ยังมีการแจ้งเตือนค้างอยู่ |
| :hourglass_flowing_sand: | **กำหนดเวลาเปิดหน้าจอเอง** | เปิดหน้าจอไว้ 5 ถึง 30 วินาทีแทนการหมดเวลาหน้าจอของระบบ |
| :mag: | **กรองแอป** | เลือกได้อย่างเจาะจงว่าแอปไหนปลุกหน้าจอได้ |
| :chart_with_upwards_trend: | **สถิติความสนใจ** | นับอยู่ในเครื่องว่าในรอบ 30 วันที่ผ่านมา แอปไหนปลุกหน้าจอแล้วไม่เคยถูกเปิดดูเลย |
| :clipboard: | **บันทึกการแจ้งเตือน** | บันทึกทุกการแจ้งเตือนว่าปลุกหน้าจอหรือไม่และถูกกฎข้อไหนสกัด พร้อมแผนภาพกระบวนการตรวจสอบแบบเรียลไทม์ |
| :new_moon: | **โหมดมืด** | หน้าตาโหมดมืดที่เข้ากับจอ AMOLED |
| :closed_lock_with_key: | **ไม่ต้องต่อเน็ต** | ทำงานอยู่ในเครื่องทั้งหมด ไม่เก็บข้อมูลและไม่ติดต่อเซิร์ฟเวอร์ |
| :zap: | **เบา** | ใช้ทรัพยากรน้อยมากและแทบไม่กระทบแบตเตอรี่ |
