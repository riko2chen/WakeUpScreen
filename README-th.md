...
| **เตือนซ้ำ** | สว่างซ้ำทุก 5–1440 นาที ตราบใดที่ยังมีการแจ้งเตือนค้างอยู่ |
...
> **เรื่องสิทธิ์การเข้าถึง** ฟังก์ชันเปิดหน้าจอจากการแจ้งเตือนต้องการสิทธิ์เข้าถึงการแจ้งเตือน โดยไม่ขอสิทธิ์อินเทอร์เน็ต
> การตั้งเวลาเปิดหน้าจอแบบกำหนดเองใช้สิทธิ์การช่วยเหลือพิเศษบน Android 9 ขึ้นไป ส่วนเงื่อนไข Bluetooth ใช้สิทธิ์อุปกรณ์ใกล้เคียงบน Android 12 ขึ้นไป
> การสั่นเตือนซ้ำใช้สิทธิ์สั่นปกติ ฟีเจอร์ใหม่ปิดไว้หรือใช้การตั้งค่าเดิมเป็นค่าเริ่มต้น และไม่อ่านเนื้อหาบนหน้าจอ

## คุณสมบัติเพิ่มเติม

ทั้งหมดนี้เปิดหรือปิดได้ตามใจ

- **การตั้งค่าเตือนซ้ำ** — เลือกแอป ช่วงเวลา 5–1440 นาที ระยะเวลาเปิดหน้าจอแยกต่างหาก และการสั่นตามต้องการ ระบบประหยัดพลังงานอาจทำให้เตือนช้า
- **เงื่อนไข Bluetooth** — อนุญาตให้เปิดหน้าจอเฉพาะเมื่อตรวจพบว่าอุปกรณ์ที่จับคู่และเลือกไว้เชื่อมต่ออยู่
