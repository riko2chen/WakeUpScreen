...
| :hourglass_flowing_sand: | **Custom Screen-On Duration** | Choose exactly how long the screen stays on — 3 to 30 seconds — instead of leaving it to the system screen timeout. |
